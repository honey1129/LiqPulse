...
LIQUIDATION_RADAR_DB_HISTORY_ENABLED="${LIQUIDATION_RADAR_DB_HISTORY_ENABLED:-true}"
...
LIQUIDATION_RADAR_DB_HISTORY_ENABLED=${LIQUIDATION_RADAR_DB_HISTORY_ENABLED}
...
export_runtime_env() {
  ...
  export LIQUIDATION_RADAR_DB_HISTORY_ENABLED
